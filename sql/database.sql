...
-- 9. Galleries Table (Dokumentasi Foto Aksi & Relawan)
...
-- 10. Password Resets Table (Reset Kata Sandi Anggota via Email OTP)
...
-- 11. Banners Table (Promo & Informasi Carousel Beranda)
...
-- Sample Banners (Promo & Informasi)
