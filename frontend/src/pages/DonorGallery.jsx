...
export const DonorGallery = () => {
  ...
  // Curated initial gallery items as baseline fallback
  const initialItems = [
    {
      id: 1,
      ...
      donor_name: 'Relawan Redor OBABA',
      blood_type: 'O+',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      donor_name: 'Komunitas Pemuda Cikupa',
      blood_type: 'B+',
    },
    {
      id: 4,
